...
#define	CCLK		  SystemCoreClock	/* cclk frequency [Hz] */
#define PCLK_SSP	SystemCoreClock	/* PCLK frequency for SSP [Hz] */
#define SCLK_FAST	1600000UL	/* SCLK frequency under normal operation [Hz] */
#define	SCLK_SLOW	100000UL	/* SCLK frequency under initialization [Hz] */
...
#define	CS_LOW()	{LPC_GPIO0->MASKED_ACCESS[1<<2] = (0<<2);}	/* Set P0.16 low */
#define	CS_HIGH()	{LPC_GPIO0->MASKED_ACCESS[1<<2] = (1<<2);}	/* Set P0.16 high */
